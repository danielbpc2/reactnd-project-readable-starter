...
// addPost({id: `${Math.random().toString(36).substr(-8)}`, timestamp: Date.now(), title: 'fuck yeah', body: 'post body asdtest', author: 'adaniel', category: 'react'})
// votePost("8xf0y6ziyjabvozdd253nd", "upVote")
// editPost("8xf0y6ziyjabvozdd253nd", {title: 'test'})
// deletePost("8xf0y6ziyjabvozdd253nd")
// addComment({id: `${Math.random().toString(36).substr(-8)}`, timestamp: Date.now(), body: 'hey fellow test', author: 'danielbpc', parentId: '894tuq4ut84ut8v4t8wun89g'})
